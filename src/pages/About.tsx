        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg prose-slate max-w-none">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <img src="/public/journey/2018-god-speaks.jpeg" alt="God Speaks LOUDER" className="w-full h-80 rounded-2xl shadow-lg object-cover" />
              <img src="/public/journey/2018-new-level.jpeg" alt="A New Level in 2018" className="w-full h-80 rounded-2xl shadow-lg object-cover" />
            </div>
